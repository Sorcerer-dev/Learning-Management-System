...
const StaffAttendance = () => {
    const [students, setStudents] = useState([
        ...
        { id: 3, name: 'Charlie Davis', present: true },
        { id: 4, name: 'Diana Clark', present: true },
        { id: 5, name: 'Ethan Wright', present: true },
        { id: 6, name: 'Fiona Lewis', present: false },
        { id: 7, name: 'George Harris', present: true },
        { id: 8, name: 'Hannah Martin', present: true },
        { id: 9, name: 'Ian Thompson', present: false },
        { id: 10, name: 'Julia White', present: true },
        { id: 11, name: 'Kevin Lee', present: true },
        { id: 12, name: 'Laura Hall', present: true },
    ]);
        ...
        <div className="p-6 max-w-7xl mx-auto animate-in fade-in zoom-in-95 duration-300">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4 bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
                <div>
                    ...
                    <p className="text-slate-500 mt-1 font-medium">B.Sc Computer Science - Batch A</p>
                </div>
