        ...
        <div className="p-6 max-w-5xl mx-auto animate-in fade-in duration-300">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4 bg-white p-6 rounded-2xl shadow-sm border border-slate-100 text-slate-800">
                <div>
                    ...
                    <p className="text-slate-500 font-medium mt-1">Select a class to begin marking attendance</p>
                </div>
                {students.length > 0 && (
            ...
            {students.length === 0 ? (
                <div className="bg-white rounded-xl shadow-sm border border-border p-12 flex flex-col items-center justify-center text-center">
                    ...
                    <p className="text-sm text-slate-400 mt-2 max-w-md">
                        Student lists will populate here once class schedules and batch assignments are configured.
                    </p>
                </div>
            ) : (
                <>
