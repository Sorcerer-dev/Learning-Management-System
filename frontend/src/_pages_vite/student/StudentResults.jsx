...
const StudentResults = () => {
    // Will be populated from PermanentMarks table via API
    const results = [];
        ...
        <div className="p-6 animate-in fade-in duration-500">
            ...
            {results.length === 0 ? (
                <div className="bg-white rounded-xl shadow-sm border border-border p-12 flex flex-col items-center justify-center text-center">
                    ...
                    <h3 className="text-lg font-bold text-slate-700">No results published yet</h3>
                    <p className="text-sm text-slate-400 mt-2 max-w-md">
                        Your academic results will appear here once the Controller of Examinations publishes them.
                    </p>
                </div>
            ) : (
