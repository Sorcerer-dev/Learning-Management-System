...
const StaffManagement = () => {
    ...
    const handleToggleStatus = (staff) => {
        ...
        statusMutation.mutate({ id: staff.id });
    };
                                            ...
                                            <tr key={staff.id} onClick={(e) => {
                                                ...
                                                <td className="px-6 py-4 text-center whitespace-nowrap" onClick={(e) => e.stopPropagation()}>
                                                    <button
                                                        ...
                                                        className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 mx-auto ${staff.status === 'Active' ? 'bg-emerald-500' : 'bg-slate-300'}`}
